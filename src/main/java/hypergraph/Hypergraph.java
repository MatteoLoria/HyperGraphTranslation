...
public class Hypergraph {
	 ...
	 * 
	 * for (vc = 1; vc <= maxVC; vc++ ) { found = false; util.CombinationIterator<String>
	 * cit = new util.CombinationIterator<String>(vertices,vc); while (cit.hasNext() &&
	 * !found) { util.PowerSetIterator<String> psetX = new
	 * util.PowerSetIterator<String>(cit.next()); LinkedList<Integer> usedE = new
	 ...
	 * return vc-1; }
	 * 
	 * private boolean VCdimHelper(util.PowerSetIterator<String> itPSetX, ArrayList<Edge>
